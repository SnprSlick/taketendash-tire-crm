...
5.  **Deploy Frontend**:
    ...
    *   **Configuration**:
        ...
        *   **Variables**:
            *   `NEXT_PUBLIC_BACKEND_URL`: `https://<your-backend-url>.up.railway.app` (IMPORTANT: Must be the public URL of your deployed Backend service)
...
2.  **Restore to Railway**:
    ...
    *   Pipe the backup to the Railway database:
        ```bash
        cat backups/backup-invoices-recon-2025-11-25T17-37-19-603Z.jsonl | railway connect --service postgres
        ```
